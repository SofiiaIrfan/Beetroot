...
const id03 = new Track('id03', 1964, "LYNYRD SKYNYRD", "FREE BIRD", '4-43lLKaqBQ');
...
const id07 = new Track('id07', 1977, "QUEEN", "WE WILL ROCK YOU", 'tJYN-eG1zk');
const id08 = new Track('id08', 1977, "METALLICA", "ENTER SANDMAN", 'CD-E-LDc384');

const playList = [id01, id02, id03, id04, id05, id06, id07, id08];
